...
def store_document_embeddings(
    ...
    Args:
    - file_path (str): Path to the document (Word, PDF, Excel)
    ...
    collection.add(
        ...
        ids=[f'chunk_{i}' for i in range(len(text_chunks))]  # Unique IDs for each chunk
    )
...
def main():
    try:
        ...
        file_paths = [
            r'Documents\Proposal- Embedding Solution Set in a React App with Virtual Customer Service Rep.pdf',
            r'Documents\Example_Excel_File.xlsx'  # Add an example Excel file
        ]
